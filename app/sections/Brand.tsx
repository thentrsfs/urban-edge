...
const Brand = () => {
	...
	return (
		<section
			...
			<div className='absolute top-10 left-1/2 -translate-x-1/2 text-lg font-heading tracking-widest text-muted uppercase items-center flex flex-col continue-hint opacity-0'>
